-- =====================================================
-- DATABASE UPDATE: ADD INGREDIENT STOCK MANAGEMENT
-- =====================================================
-- This script adds the missing ingredient management functions
-- and triggers to your existing database schema
-- =====================================================
...
-- =====================================================
-- 1. FUNCTION: Check ingredient availability
-- =====================================================
...
-- =====================================================
-- 2. FUNCTION: Get menu item availability with detailed info
-- =====================================================
...
SELECT 'Triggers created:' as status, trigger_name, event_object_table
...
-- SUCCESS MESSAGE
-- =====================================================
SELECT 'Database updated successfully with ingredient stock management system!' as result;
